...
\newcommand{\mytitle}{Your super awesome title}
\title{\mytitle}
\newcommand{\myauthor}{Your Name}
\author{\myauthor}
\year=2018
\newcommand{\mysubtitle}{\the\year~SEAS Student Research and Development Showcase}
\subtitle{\mysubtitle}
...
\begin{block}{Title of the block} % Background block
	...
	\begin{figure}
        ...
        \begin{subfigure}[b]{0.4\columnwidth}%
                \includegraphics[height=6.5cm]{hubble}%
                \caption{Hubble}%
                \label{fig:hubble}%
        \end{subfigure}%
        \hspace*{\fill}%
        \begin{subfigure}[b]{0.4\columnwidth}%
                \includegraphics[height=6.5cm]{ors-1}%
                \caption{Agile S/C}%
                \label{fig:ors}%
        \end{subfigure}%
		\hspace*{\fill}%
...
\begin{block}{The big middle block} % structure block
	\begin{minipage}{0.4938\columnwidth} % left half of this block
	\begin{itemize}
	...
	\begin{minipage}{0.4938\columnwidth}% right half of block
		\begin{itemize}
